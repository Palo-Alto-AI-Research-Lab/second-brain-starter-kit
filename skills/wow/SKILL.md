...
```
тир        куда                                        статус
teaser RU  чат @ClawRus  -1006847702008                🟢 армировано (авто после «+»)
teaser EN  чат ClawEng «OpenClaw Gods» -1006751373534  🟢 записан Антоном («Claw Inc» в голосовой = ClawEng; наши аккаунты админы)
medium RU  RU-канал (id даст Нина)                   ⏳ кандидат: «OpenClaw Lab - Все об OpenClaw» -1003711559525 — НЕ постить до подтверждения
medium EN  EN-канал (id даст Нина)                   ⏳ кандидат: «OpenClaw + AI Engineers ClawEng» -1000598069731 — НЕ постить до подтверждения
