...
Когда работу надо продолжить НЕ здесь (другая машина, другой человек — Антон↔Руслана↔Наташа, или просто новая сессия после `/compact`), `/handoff` собирает один самодостаточный документ, по которому подхватят с холода. Убирает «а что вы тут делали».
...
- Для человека-ассистента, который смотрит дашборды (Руслана/Наташа): продублировать/положить в
...
- Повторяющаяся передача Антон↔Руслана по звонкам/задачам = один вызов вместо ручной сборки.
