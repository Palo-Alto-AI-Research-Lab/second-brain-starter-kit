...
- машинно-специфичный хардкод: `grep -n "C:\\\\Users\\\\[^_]" <файл>` — путь с ЧУЖИМ юзером/машиной в общем движке обязан идти через `_paths.py`/machine.env (грабли 2026-07-04: хаб вшил `C:\Users\Anton`, на ноуте путь мёртв → тихий fallback);
